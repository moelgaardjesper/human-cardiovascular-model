...
def simulate():
    ...
    return jsonify({
        ...
        "brachial_p":   _round(result["brachial_p"]),
        "brachial_sbp": _round(result["brachial_sbp"]),
        "brachial_dbp": _round(result["brachial_dbp"]),
        ...
        "summary": {
            ...
            "dbp_mean":          _mean("dbp"),
            "sbp_mean":          _mean("sbp"),
            "brachial_sbp_mean": _mean("brachial_sbp"),
            "brachial_dbp_mean": _mean("brachial_dbp"),
            "cpp_mean":          _mean("cpp"),
            "cop_mean":          _mean("cop"),
